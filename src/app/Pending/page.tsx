...
const FoodOrders = () => {
  ...
  const handleRemove = (id: string) => setOrders((prev) => prev.filter((o) => o.id !== id));
  ...
  return (
    ...
    <div className="min-h-screen bg-white flex flex-col items-center">
      <div>
        <h1 className="text-xl font-bold mb-3 text-gray-900 tracking-tight mt-5">Pending Orders</h1>
      </div>
